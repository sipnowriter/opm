...
import { Activity, Users, FileText, DollarSign, Calendar } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Overview of your Hexancare outpatient management system</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">6 pending, 18 completed</p>
          </CardContent>
        </Card>
